...
function* start() {
  console.error(`loading github prCache file from ${proboConfig.githubPrCacheFile}`);
  github.loadPrCache(proboConfig.githubPrCacheFile);
  ...
  console.error(`saving github prCache file to ${proboConfig.githubPrCacheFile}`);
  github.savePrCache(proboConfig.githubPrCacheFile);
}
